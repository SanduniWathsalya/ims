...
const ReturnItem = ({ image, price, cancellationDate, onConfirm }) => {
    ...
    <div className="w-full max-w-full mx-auto rounded overflow-hidden shadow-lg bg-gray-100 p-4 mb-4">
      <div className="flex items-center">
        ...
        <div className="flex-1">
          ...
          <p className="text-gray-700 text-base">Cancellation Date: {cancellationDate}</p>
          <button
            onClick={onConfirm}
...
<div className="flex justify-end h-12 bg-white border-b border-gray-200">
  ...
  <div className="  w-full p-10 h-screen sm:w-[400px] md:w-[600px] lg:w-[1100px] max-w-full mx-auto">
  <div className="grid grid-cols-1 gap-6">
    <h1 className="text-black text-2xl">My Cancellations</h1>
    {/* Dummy list of return items */}
    <div className=" grid grid-cols-4 gap-30 border border-gray-300 p-4 rounded-lg">
      {/* First Column */}
      <div className="flex flex-col justify-between">
        <p className="text-gray-600">Canceled Date: 2025-01-05</p>
  ...
  <Link href="/">
    ...
    <div className="grid grid-cols-4 gap-30 border border-gray-300 p-4 rounded-lg">
      {/* First Column */}
      <div className="flex flex-col justify-between">
        <p className="text-gray-600">Canseled Date: 2025-01-06</p>
